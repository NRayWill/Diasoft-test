...
-- 2. Вывести список сотрудников, получающих максимальную заработную плату в 
...
-- 4. Вывести список ID руководителей, заработная плата которых больше или 
...
-- 5. Найти список наименований отделов с
...
-- 6. Вывести имена агентов, совершавших платежи с 01.05.2016 по 20.05.2016,
...
-- 7. Вывести имена агентов, по которым нет платежей 166-го типа.
-- Без использования подзапросов, только соединение таблиц.
...
-- 8. Найти платежи агентов, наименование которых начинается на «банк» 
-- (независимо от регистра символов) и вывести их в порядке возрастания даты
-- платежа. Нужно вывести наименование агента, дату платежа, сумму платежа,
